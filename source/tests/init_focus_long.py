...
xaini = -500 ;         # initial position, with respect to focus
yaini = 0 ;
yafocus = 500 ;      # distance to focus transversly, does not matter here
...
ampb = 0.0*np.sqrt(ua0energy/alphaen)
